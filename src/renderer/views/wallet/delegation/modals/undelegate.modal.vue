    ...
    <div class="basic-form modal-body">
      ...
      <form class="basic-form">
        ...
        <ul class="basic-group clearfix">
          ...
          <li class="token">
            <label>Token</label>
            <input v-model="transfer.token" type="text" placeholder="0" disabled />
          </li>
        </ul>
        ...
        <div>
          <b-alert show style="margin-top: 10px" variant="warning"
            >{{ $t('undelegation_warning') }}
            <a
              href="https://medium.com/ki-foundation/a-guide-to-staking-on-the-kichain-3d69a71b50e9"
              target="_blank"
            >
              Learn more</a
            >.</b-alert
...
export default {
  ...
  methods: {
    ...
    setTokens(flag) {
      var delegation =
        this.currentWallet.delegation.find(
    ...
    download() {
      ...
      return util.download(
        date_today + '_undelegate_' + this.undelegate.amount + 'xki' + '.json',
        document,
