        ...
        <b-row align-v="center" align-h="center">
          <b-col class="text-center">
            <div v-if="!tx.loading">
              ...
              <span v-else>
                <a v-if="delegate.output == ''" class="btn btn-primary" @click="sendDelegateTx"> Generate </a>
...
export default {
  ...
  methods: {
    ...
    raiseCDA() {
      if (
        parseFloat(this.currentWallet.balances.delegated.replace(/,/g, '')) > 100000000 &&
        this.delegate.amount > 100
      ) {
        this.show = true;
      }
    ...
    download() {
      ...
      return util.download(
        date_today + '_delegate_' + this.delegate.amount + 'xki' + '.json',
        document,
