export default {
  ...
  webwallet_edit_title: 'Edit wallet',
  error_wallet_invalid:
    'This wallet has not been imported properly and cannot be used. Please delete it from the wallet list and import it again.',
  warning_wallet_invalid_delete:
    'Warning! Deleting this wallet will result in the loss of all it data from the Ki Desktop Wallet application.',
  ...
  enter_ms_address_pubkeys_error:
    'The number of participants needs to be equal to or greater than the threshold',
  ms_address_unknown:
    'This address is not yet known by the blockchain. Please fill in the following data to import it.',
  ...
  wallet_category: 'Pick a category for your wallet',
  ...
  webwallet_sign_participants: 'Participants',
  webwallet_sign_threshold: 'Threshold',
  webwallet_sign_participants_sig: 'Signatures',
  ...
  webwallet_drag_drop_data: 'Drag and drop your raw data file here',
  ...
  undelegation_warning:
    'Undelegation freezes tokens for 21 days. You migh need to consider redelgation instead.',
