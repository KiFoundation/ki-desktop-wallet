                ...
                <b-row v-if="step != 0" style="margin-bottom: 10px">
                  ...
                  <b-col v-if="step == 1 || step == 2">
                    ...
                    <b-row style="margin-bottom: 20px">
                      ...
                      <b-col v-if="step == 2"
                        >Fill in the missing words to complete the verification
                        <a @click="switchVerficatioMode">
                          <span v-if="easy">
                            <img
                              id="easy-target"
                              src="/img/icons/lightning-easy.png"
                    ...
                    <div class="contents">
                        ...
                        <ul>
                          <li v-for="(item, idx) in mnemonic_array" v-bind:key="'w' + idx">
                            <div
                              ...
                              "
                            >
                              <label style="margin: 0px" :for="'w' + idx">{{ idx + 1 }}.</label>
                              <input
                                autocomplete="off"
                                :id="'w' + idx"
                                type="text"
                                v-model="mnemonic_array[idx]"
                              />
                            </div>
                          </li>
                        </ul>
                      ...
                      <div v-if="step == 2" class="phrases">
                        <ul>
                          <li
                            v-for="(item, idx) in mnemonic_array_sub"
                            :ref="'ws' + idx"
                            v-bind:key="'ws' + idx"
                          >
                            <div
                              ...
                              "
                            >
                              <label style="margin: 0px" :for="'ws' + idx">{{ idx + 1 }}.</label>
                              <input
                                autocomplete="off"
                                :id="'ws' + idx"
                                type="text"
                                v-model="mnemonic_array_sub[idx]"
                              />
                            </div>
                          </li>
                        </ul>
...
export default {
  ...
  methods: {
    ...
    generateWallet() {
      this.mnemonic_create = generateMnemonic(256);
