            ...
            <div class="mnemonic-form">
              <div v-if="step == 0">
                ...
                <b-row style="margin-bottom: 10px; margin-top: 20px">
                  ...
                  <b-col style="text-align: right">
                    <a @click="workflow_cat[editing].onPress(), (editing = !editing)">{{
                      workflow_cat[editing].label
                    }}</a>
                  </b-col>
                </b-row>
                ...
                <b-row align-v="center">
                  <b-col v-if="!editing">
                    <b-button
                      v-for="(cat, idx) in categories_.split(',')"
                      size="sm"
                      :key="idx"
                      :pressed="filter === cat"
...
import { SET_CATEGORY_LIST } from '@store/wallets';
