    ...
    <b-col>
      <b-row class="w-100 align-items-center">
        <b-col cols="3" class="flex-row d-flex align-items-center">
          <div :style="{ position: 'relative' }">
            <b-avatar
              ...
              :text="validator.description.moniker.toUpperCase().match(new RegExp(/[A-Za-z]/))[0]"
        ...
        <b-col cols="1">
          <b-badge
            v-if="
              validators_dict[validator.operator_address].status == 'UNBONDED' ||
              validators_dict[validator.operator_address].status == 'UNBONDING'
            "
            class="badge-delegate"
          >
            Jailed
          </b-badge>
          <b-badge v-else> Active </b-badge>
        </b-col>
